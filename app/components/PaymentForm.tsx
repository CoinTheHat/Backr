    ...
    if (txHash) {
        return (
            <div className="bg-white p-8 rounded-2xl shadow-xl border border-emerald-100 max-w-md mx-auto text-center animate-in fade-in zoom-in duration-300">
                ...
                <p className="text-slate-500 mb-6">Your payment of {amount} AlphaUSD has been successfully processed.</p>
    ...
    return (
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-100 max-w-md mx-auto">
            <div className="mb-8">
                ...
                <p className="text-slate-500">Quickly send AlphaUSD to any email, phone, or wallet.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700 block">Amount (AlphaUSD)</label>
